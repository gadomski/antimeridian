...
A common method of representing locations on and around planet Earth is with a latitude, longitude, and height in what is known as a geodetic coordinate system.
Longitudes, the "horizontal" coordinate, usually are considered to cover the domain from -180° to 180° or 0° and 360°.
...
Briefly, it breaks each polygon into segments and finds where those segments might cross the antimeridian.
...
To our knowledge, it has been ported to at least one other language in the [go-geospatial/antimeridian](https://pkg.go.dev/github.com/go-geospatial/antimeridian).
...
We would also like to acknowledge our employers, Development Seed and Element 84, who support open source software through direct funding and developer contribution.
